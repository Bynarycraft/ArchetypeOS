...
import { LayoutDashboard, BookOpen, Users, BarChart3, Clock, Map } from "lucide-react";
...
export async function Sidebar() {
    ...
    return (
        <div className="flex h-screen w-64 flex-col border-r border-border/40 bg-card/60 backdrop-blur-2xl text-card-foreground p-6 shadow-2xl shadow-primary/5">
            {/* Header */}
